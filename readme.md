...
-- (Please note as I am still a high school student, my time to work on this project is limited, however I'll try to be available for support/suggestions as often as possible, so feel free to [open an issue](https://github.com/labbo-lab/webeditor/issues/new])!)
...
| Function | Shortcut |
| ----------- | ----------- |
| Unindent | <kbd>Ctrl</kbd> + <kbd>[</kbd> |
| Indent | <kbd>Ctrl</kbd> + <kbd>]</kbd> or  <kbd>Tab</kbd>|
